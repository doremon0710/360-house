...
class Overview extends React.Component {
  ...
  onOpenModal = () => {
    ...
    onSubmit2(){
      path.push({
      pathname: ROUTES.CLIENT},remember);
    };
  ...
  render(){
    ...
    return(
      ...
      <div style={{"padding" : "20px"}}>
        ...
        <Col xs={1} >
        <SingleAgent />
        <Button variant="primary" style={{"margin-top":"10px", "align": 'center'}} onClick={this.onOpenModal}>Contact me</Button>
        ...
        <Button onClick={(e) => this.onSubmit2()}>Email Me</Button>
        </span></Col>
        </Row>
        </Col>
