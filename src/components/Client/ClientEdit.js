//a form to allow client making changes and submit new account information to firebase
...
class SubmitForm extends React.Component {
    ...
    onSubmit() {
        ...
        render() {
          ...
          return (
            <div>
            <h3 style={{"textAlign": "center"}}> Edit your account information</h3>
            ...
            <form className="container-fluid" onSubmit={this.handleFormSubmit}>
              ...
              />{" "}
              {/* Clear the form */}
              <p>Click submit for final submission or clear to undo</p>
